    ...
    public function updaterecord($id) {
        ...
        if($post['checked'] =='check'){
            ...
            $passwordsend = $post['user_password'];
                    ...
                    $this->email->message('<h1>WELCOME TO CRICKET-X</h1><br>Hello <u>' . $post['user_name'] . '</u> You are receiving this email because you recently changed your email or password  at "<strong>Cricket-X</strong>" <br><br><br>Now you can login from below given details into the site!<br><br><br>Email:' .$emailsend.'<br><br>password:  '.$passwordsend.'if you have any problems Verifing your account please reply to this email to get instance<br><br>Thanks');
